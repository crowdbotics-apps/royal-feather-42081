"""
Django settings for royal_feather_42081 project.
...
ROOT_URLCONF = 'royal_feather_42081.urls'
...
WSGI_APPLICATION = 'royal_feather_42081.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_feather_42081 API",
    "DESCRIPTION": "API documentation for royal_feather_42081 App",
    "VERSION": "v1",
}
